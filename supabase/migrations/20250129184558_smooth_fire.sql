/*
  # Wedding App Schema and Security

  1. Tables
    - weddings: Store wedding details
    - guests: Store guest information
    - photos, audios, messages: Store memories
  
  2. Security
    - Enable RLS on all tables
    - Public can view all data
    - Public can create guests and memories
    - Anyone can create weddings (changed from authenticated only)
*/
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Weddings are insertable by anyone" ON weddings;
  ...
  CREATE POLICY "Weddings are insertable by anyone"
